...
public class AdminUserController {
    ...
    public void menu() {
        ...
        while (run) {
            ...
            switch (menu) {
                case 1:
                    adminUserService.showAllUsers(); // 전체 회원 조회
                    break;
                case 2:
                    adminUserService.approveUser(); // 회원 승인
                    break;
                case 3:
                    adminUserService.processWithdraw(); // 탈퇴 요청 처리
                    break;
                case 4:
                    adminUserService.changeUserRole(); // 권한 변경
                    break;
                case 0:
                    run = false;
                    break;
