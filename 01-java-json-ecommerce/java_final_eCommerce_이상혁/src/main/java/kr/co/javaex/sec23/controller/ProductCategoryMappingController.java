...
public class ProductCategoryMappingController {
    ...
    public void menu() {
        ...
        while (run) {
            ...
            switch (menu) {
                case 1:
                    mappingService.showAllMappings(); // 매핑 목록 조회
                    break;
                case 2:
                    mappingService.addMapping(); // 매핑 등록
                    break;
                case 3:
                    mappingService.updateMapping(); // 매핑 수정
                    break;
                case 4:
                    mappingService.deleteMapping(); // 매핑 삭제
                    break;
                case 0:
                    run = false;
                    break;
