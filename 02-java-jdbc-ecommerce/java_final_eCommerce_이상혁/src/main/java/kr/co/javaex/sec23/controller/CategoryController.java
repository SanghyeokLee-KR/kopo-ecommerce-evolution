...
public class CategoryController {
    ...
    public void menu() {
        ...
        while (run) {
            ...
            switch (menu) {
                case 1:
                    categoryService.showAllCategories(); // 1. 카테고리 목록 조회
                    break;
                case 2:
                    categoryService.addCategory(); // 2. 카테고리 등록
                    break;
                case 3:
                    categoryService.updateCategory(); // 3. 카테고리 수정
                    break;
                case 4:
                    categoryService.deleteCategory(); // 4. 카테고리 삭제
                    break;
                case 0:
                    run = false; // 0. 이전 메뉴
                    break;
